...
document.writeln("                     ");
document.writeln("                  ");
document.writeln("                      <a href=\'http://www.websoft9.com/xdocs/lamp-image-guide' target=\'_blank\' \' class=\'nav-link tpl-left-nav-link-list\'>");
document.writeln("                            <i class=\'am-icon-book\'></i><span>LAMP镜像手册</span>");
document.writeln("");
document.writeln("                        </a>");
document.writeln("                     ");
document.writeln("                    </li>");
