...
!function (window, undefined) {
    ...
    function _create(a, b) {
        ...
        if (b = b || {}, b.basePath = _undef(b.basePath, K.basePath), b.themesPath = _undef(b.themesPath, b.basePath + "themes/"), b.langPath = _undef(b.langPath, b.basePath + "lang/"), b.pluginsPath = _undef(b.pluginsPath, b.basePath + "plugins/"), _undef(b.loadStyleMode, K.options.loadStyleMode)) {
            ...
            _loadStyle(b.themesPath + "css"), _loadStyle(b.themesPath + d + "/" + d + ".css")
        }
        var e = K(a);
        if (e && 0 !== e.length) {
    ...
    if (!window.KindEditor) {
        ...
        var _VERSION = "4.1.12 (2017-04-12)", _ua = navigator.userAgent.toLowerCase(),
        ...
        _extend(KRange, {
            ...
            init: function (a) {
                ...
                var c, d, e = this, f = _removeUnit(a) || 0, g = _removeUnit(b) || 0, h = _getScrollPos();
                if (e._alignEl) {
                    var i = K(e._alignEl), j = i.pos(), k = _round(i[0].clientWidth / 2 - f / 2),
                        l = _round(i[0].clientHeight / 2 - g / 2);
                    c = 0 > k ? j.x : j.x + k, d = 0 > l ? j.y : j.y + l
                } else {
                    var m = _docElement(e.doc);
                    c = _round(h.x + (m.clientWidth - f) / 2), d = _round(h.y + (m.clientHeight - g) / 2)
                }
                return _IE && 7 > _V || _QUIRKS || (c -= h.x, d -= h.y), e.pos(c, d)
            }, remove: function () {
                var a = this;
        ...
        KEditor.prototype = {
            lang: function (a) {
                ...
                if (c = _undef(c, !0), a && (/%/.test(a) || (a = _removeUnit(a), a = a < d.minWidth ? d.minWidth : a), d.container.css("width", _addUnit(a)), c && (d.width = _addUnit(a))), b) {
                    ...
                    e = e < d.minHeight ? d.minHeight : e, d.edit.setHeight(e), c && (d.height = _addUnit(b))
                }
                return d
            }, select: function () {
    ...
    function d() {
        f = a.removeUnit(e.height), e.edit.afterChange(c), e.fullscreenMode || b(), c()
    }
    ...
    b.clickToolbar(c, function () {
        var d = b.lang(c + "."),
            ...
            f = b.createDialog({
                ...
                yesBtn: {
                    name: b.lang("yes"), click: function () {
                        var c = a(".ke-code-type", f.div).val(), e = g.val(), h = "" === c ? "" :  c,
                            i = '<pre><code class="language-' + h + '">\n' + a.escape(e) + " </code></pre> ";
    ...
    window.SWFUpload = function (a) {
        ...
        var b,
            c = (window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : ""), window.location.pathname.lastIndexOf("/"));
        return b = 0 >= c ? "/" : window.location.pathname.substr(0, c) + "/", b + a
