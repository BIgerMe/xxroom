...
<div id="" class="mainBody">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--                <li><a href="/blogshow/life"><span class="glyphicon glyphicon-glass"></span>生活</a></li>-->
                    <li><a href="/blog/index"><span class="glyphicon glyphicon-pencil"></span>个人后台</a></li>
                    <?php if (@$user_info): ?>
                        <li class="dropdown">
    ...
    <div class="container head" style="width:100%">
        ...
        <form action="/personal/search" method="get" enctype="application/x-www-form-urlencoded" class="form-style">
            <div class="input-group input-group-lg">
                <input type="text" class="form-control" name="key" value="<?= $key ?>" autocomplete="off"
                       placeholder="php">
    ...
    <div class="" style="padding-bottom: 10px;">
        <div class="container-fluid" style="padding:0">
            <div class="row">
                <div class="col-md-12 img-header">
                    <img style="height:45px;width:120px" src="https://www.wailian.work/images/2018/12/26/blog.png" class="media-object" alt="">
                    <hr/>
                </div>
                <div class="col-md-12" style="padding: 0">
                    <div class="container" style="padding: 0">
                        <?php if ($blog): foreach ($blog as $b): ?>
                            <div class="col-xs-12 col-md-6 col-sm-12 info-content" data-id="<?= $b['id'] ?>">
                                <div class=" col-md-2 col-sm-2 col-xs-2 blog-avatar">
                                    <img style="width:64px;float: right" src="<?= $b['avatar'] ?>" class="img-responsive img-circle" alt="">
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding:3px 0 ;background: white">
                    <img style="width:100px" src="https://www.wailian.work/images/2018/12/26/FQA.png" class="media-object" alt="">
                </div>
                <div class="col-md-8">
                    <div class="container-fluid" style="padding: 0">
                        <?php if ($blog): foreach ($blog as $b): ?>
