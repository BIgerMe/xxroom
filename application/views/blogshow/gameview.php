    ...
    <div class="row body-content">
        ...
        <div class="col-md-10 col-md-offset-1 text-center" style="text-align: right">
            ...
            <?php foreach ($blog['category'] as $c): ?>
               <a class="badge" href="/blogshow/index?category=<?=$c?>"><?=$c?></a>
            <?php endforeach; ?>
        </div>
        <br/><br/>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="media">
                                ...
                                <div class="media-body"  data-id="<?=$c['id']?>">
                                    ...
                                    <p style="margin:5px 0;word-break: break-all" class="media-content"><?=$c['content']?><a class="replies" onclick="replyComment(this)">回复</a></p>
                                </div>
