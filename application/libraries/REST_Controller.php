...
abstract class REST_Controller extends CI_Controller {
    ...
    const HTTP_SWITCHING_PROTOCOLS = 101;   //HTTP交换协议
    ...
    const HTTP_NON_AUTHORITATIVE_INFORMATION = 203;    //非授权信息
    /**
    ...
    /*发送输出信息*/
    protected function send_response($status,$msg,$data = null)
    {
        $this->response_data = array('status'=>$status,'msg'=>$msg,'data'=>$data);
